export const listCat = [
  {
    ...
    editedTime: "03월 18일 10:22 직접 편집",
    category: "종합/경제",
  ...
  },
  {
    ...
    editedTime: "03월 18일 10:06 직접 편집",
    category: "종합/경제",
    url: "https://www.figma.com/file/SJHhyw3G0A4qDSWMIo9Ths/image/6e64c86ea480d1a2922e94cb3e9431fa4685a1a0",
    description: [
  ...
  },
  {
    ...
    editedTime: "03월 18일 10:14 직접 편집",
    category: "방송/통신",
  ...
  },
  {
    ...
    editedTime: "03월 18일 10:02 직접 편집",
    category: "방송/통신",
    url: "https://www.figma.com/file/SJHhyw3G0A4qDSWMIo9Ths/image/c5bfa7355e16800a64814c0f81b8fe1e7c5ff808",
    description: [
...

  {
    ...
    editedTime: "03월 18일 10:10 직접 편집",
    category: "IT",
    ...
    description: [
      "[박종면칼럼] LG가문의 '청지기' 구광모",
      "수소차 기대 사라진 스타리아, 하이브리드·전기 PBV로 인기 얻나",
      "‘LG엔솔 배터리’ 캐딜락 리릭 전기차 포착...상반기 국내 출시",
      'AI 경쟁에서 밀린 애플…"성장주 아니라 코카콜라와 같은 가치주"',
      "\"K푸드의 근원은 '전통 장' 문화에 있죠\" K발효의 산실 기순도 발효학교 [현장+]",
      '美 조기 금리인하 신중론 부상하지만…WSJ "상황 곧 바뀔 수 있다"',
      '"쉽고 다양한 중식 대중화가 내 마지막 커리어 목표‥" CU 옥사부 마라시리즈 출시한 여경옥 셰프 [人더스트리]',
    ],
  },
  {
    pressName: "디지털투데이",
    ...
    editedTime: "03월 18일 10:00 직접 편집",
    category: "IT",
    url: "https://s.pstatic.net/dthumb.phinf/?src=%22https%3A%2F%2Fs.pstatic.net%2Fstatic%2Fnewsstand%2F2024%2F0314%2Farticle_img%2Fnew_main%2F9026%2F162552_001.png%22&type=nf312_208&service=navermain",
    description: [
      "글로벌 보안 시장 M&A 확대일로...대형 전문 업체 주도",
      "메조미디어, '데이터 마케팅 전문가' 백승록 신임 대표이사 취임",
      "야놀자, 경상북도 지역 활성화 위한 민관협력 프로젝트 진행",
      "AI가 동영상을 게임으로 바꿔주는 앱 '오버플레이'",
      "구글, 안드로이드용 전화앱서 '주변 장소 검색' 기능 제거…\"사용자 극소수\"",
      "애플, 올가을 USB-C 탑재된 보급형·중간급 에어팟 출시…어떤 기능 선보이나",
  ...
  },
  {
    ...
    editedTime: "03월 18일 09:55 직접 편집",
    category: "영자지",
    url: "https://f1.econotimes.com/2024/03/y8rv5l4365_th_1024x0.jpg",
    description: [
      "NK fires multiple ballistic missiles toward East Sea: JCS",
      "Ministry reiterates opposition to medical profs' plans",
      ...
      "Late poet Park Mok-wol’s 166 unpublished verses unveiled",
      "Day6 vows to continue with ‘Fourever’",
    ],
  },
  {
    pressName: "EBN",
    ...
    editedTime: "03월 18일 08:00 직접 편집",
    category: "스포츠/연예",
  ...
  },
  {
    ...
    editedTime: "03월 18일 09:57 직접 편집",
    category: "스포츠/연예",
    url: "https://cdn.spotvnews.co.kr/news/photo/202403/664915_1009758_2741.jpg",
    description: [
      "'또 안타! 볼넷까지' 이정후, 타율 0.348↑…美 \"당신이 깨닫기 전에 빠져들 것\"",
  ...
  },
  {
    ...
    editedTime: "03월 18일 10:13 직접 편집",
    category: "매거진/전문지",
  ...
  },
  {
    ...
    editedTime: "03월 18일 10:03 직접 편집",
    category: "지역",
