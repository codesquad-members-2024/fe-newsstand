...
const subscribeMap = {
    ...
    unsubscribe(press) {
        ...
        showModal()
        const unsubscribeContainer = document.querySelector(".answer-container")
...
export const setSubscribeEventHandler = () => {
    ...
    subscribeBtn.forEach((curContainer) => curContainer.addEventListener("click", subscribeToPress));
};
